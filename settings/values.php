...
$mainValues = [
    ...
    'customer_custome_plan_name'=>'🔻لطفا نام کانفیگ خود را وارد کنید!
    
    ➖➖➖➖➖➖➖➖➖➖➖➖➖➖

    •دقت داشته باشید نام کانفیگ خود را فقط با حروف انگلیسی و بدون علائم نگارشی و عدد باید وارد کنید.',
...
",
    ...
    'start_message'=>'سلاااام 🤠
    به ربات هایلو 👾 خوش اومدی 🫡❤️
    
    ما اینجاییم تا بدون هیچ محدودیتی شمارو به شبکه جهانی متصل کنیم🚀
    
    •کیفیت بالا در ساخت انواع کانکشن ها 💎
    •برقراری امنیت اطلاعات شما 👨‍💻
    •پشتیبانی تا روز آخر ⚙️
...
مدت زمان سرویس: DAYS روز',
    ...
    'incorrect_config_name'=>"نام وارد شده معتبر نمی باشد❌

    ➖➖➖➖➖➖➖➖➖➖➖➖➖➖
    
    📌لطفا دقت داشته باشید نام کانفیگ خود را فقط با حروف انگلیسی و بدون علائم نگارشی و عدد و فاصله باید وارد کنید.",
