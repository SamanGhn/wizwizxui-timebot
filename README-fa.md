...
# امکانات ویژه (ادیت شده توسط SamanGhn)
- کارت به کارت با امکان اضافه کردن 4 شماره کارت (نمایش تصادفی)
- ارسال رسید کارت به کارت داخل گروه
- امکان تایید رسیدها توسط ادمین های گروه
- تمدید سرویس با قابلیت تغییر پلن
